...
public class PushInt extends Action{

	public PushInt(CodeGenerator codeGenerator) {
		super(codeGenerator);
	...
	public void run() throws SemanticErrorException {
		...
		semanticStack.push(new Operand(OprLevel.IMMEDIATE, OprType.INT, scanner.getLexeme()));
